...
Author: 未知，仅修复皮卡生活任务，如有侵权请联系我删除
功能：福田e家&皮卡生活自动签到
账号#密码填到环境变量'ftej'里，两个APP通用，皮卡生活登录会发短信，建议拉黑名单
偶尔会报错  多定时两次就好了
Date: 2024/09/25
cron: 6 12 * * *
new Env('福田e家');
...
//console.log(`获取到话题列表[${this.a}] `)
    ...
    async kclogin() {
        try {
            ...
            let url = `https://czyl.foton.com.cn/ehomes-new/pkHome/api/user/getLoginMember2nd`;
            let body =`{"memberId": "","memberID": "","mobile": "","token": "7fe186bb15ff4426ae84f300f05d9c8d","vin": "","safeEnc": ${pktime1-10110000},"name": "${this.ck[0]}","password": "${this.ck[1]}","deviceId": "TKQ1.221114.001","deviceType": "0","versionCode": "21","versionName": "V1.1.14"}`;
            // console.log(body)
            let h = {
                "Host": "czyl.foton.com.cn",
                "Content-Type": "application/json;charset\u003dutf-8",
